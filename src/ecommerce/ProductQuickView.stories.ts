/**
 * ProductQuickView Stories - WenderMedia Astro Components
...
const meta: Meta = {
  title: 'E-commerce/ProductQuickView',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
...
- Quantity selector with increment/decrement
  ...
  argTypes: {
    ...
    productPrice: { control: 'number', description: 'Product price' },
    productDescription: { control: 'text', description: 'Product description' },
  },
};
...
const renderQuickView = (args: Record<string, unknown>) => html`
  <style>
  ...
  <div class="qv-modal">
    <div class="qv-content">
      ...
      <div class="qv-info">
        <h2 class="qv-title">${args.productName}</h2>
        <div class="qv-price">${new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(args.productPrice as number)}</div>
        <p class="qv-desc">${args.productDescription}</p>
