/**
 * SocialProofSection Stories - WenderMedia Astro Components
...
const meta: Meta = {
  ...
  tags: ['autodocs'],
  parameters: { docs: { description: { component: 'Social proof elements: ratings, reviews, trust signals. Six variants (stats, ratings, badges, reviews, combined, minimal). Built-in platform logos for Google, Trustpilot, etc.' } } },
  argTypes: { variant: { control: 'select', options: ['stats', 'ratings', 'badges', 'reviews', 'combined', 'minimal'] } },
};
export default meta;
type Story = StoryObj;
  ...
  render: () => html`
    <section style="padding:3rem 2rem;background:#f8fafc;font-family:system-ui,sans-serif;">
      ...
      <div style="display:flex;justify-content:center;gap:3rem;flex-wrap:wrap;">
        ${[{ platform: 'Google', rating: '4.8', count: '520' }, { platform: 'Trustpilot', rating: '4.6', count: '310' }, { platform: 'Capterra', rating: '4.7', count: '180' }].map(r => html`
