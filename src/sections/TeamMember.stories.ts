/**
 * TeamMember Stories - WenderMedia Astro Components
 * @copyright 2007-2026 Wender Media
 */
import type { Meta, StoryObj } from '@storybook/web-components';
import { html } from 'lit';
const meta: Meta = {
  title: 'Sections/TeamMember',
  tags: ['autodocs'],
  parameters: { docs: { description: { component: 'Individual team member card. Five variants (default, card, horizontal, minimal, overlay). Built-in social icons for LinkedIn, Twitter, GitHub, etc. Initials fallback.' } } },
  argTypes: { variant: { control: 'select', options: ['default', 'card', 'horizontal', 'minimal', 'overlay'] }, name: { control: 'text' }, role: { control: 'text' } },
};
export default meta;
type Story = StoryObj;
