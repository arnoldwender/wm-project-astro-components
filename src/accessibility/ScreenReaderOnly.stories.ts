/**
 * ScreenReaderOnly Stories - WenderMedia Astro Components
...
- Slot-based content composition
  ...
  argTypes: {
    as: { control: 'select', options: ['span', 'div', 'p', 'h2', 'label'], description: 'HTML element to render' },
    focusable: { control: 'boolean', description: 'Become visible on focus (for skip links)' },
  },
};
...
const renderScreenReaderOnly = (args: Record<string, unknown>) => html`
  <div style="padding: 2rem; font-family: system-ui, sans-serif;">
    ...
    <div style="padding: 1rem; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 0.5rem; font-size: 0.875rem; color: #64748b;">
      <p style="margin: 0;">Element: <code>&lt;${args.as || 'span'}&gt;</code>, Focusable: <code>${args.focusable || false}</code></p>
