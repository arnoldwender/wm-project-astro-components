/**
 * GoogleMap Stories - WenderMedia Astro Components
...
- Supports roadmap, satellite, hybrid, and terrain map types
  ...
  argTypes: {
    ...
    consentText: { control: 'text', description: 'Consent message' },
  },
};
...
const renderGoogleMap = (args: Record<string, unknown>) => html`
  <div style="width: 100%; height: ${args.height}; position: relative; background: #e5e7eb; border-radius: 0.5rem; overflow: hidden; font-family: system-ui, sans-serif;">
    <div style="position: absolute; inset: 0; display: flex; align-items: center; justify-content: center;">
      ...
      <div style="position: relative; z-index: 1; text-align: center; color: white; max-width: 400px; padding: 1.5rem;">
        ...
        <h3 style="margin: 0 0 0.5rem; font-size: 1.25rem; font-weight: 600;">${args.title}</h3>
        <p style="margin: 0 0 1.5rem; font-size: 0.875rem; opacity: 0.9; line-height: 1.5;">${args.consentText}</p>
