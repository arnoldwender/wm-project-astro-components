/**
 * CommandPalette Stories - WenderMedia Astro Components
...
- Reduced motion support
  ...
  argTypes: {
    ...
    maxResults: { control: 'number', description: 'Maximum results to display' },
    showRecent: { control: 'boolean', description: 'Show recent searches section' },
  },
};
...
const renderCommandPalette = (args: Record<string, unknown>) => html`
  ${paletteStyles}
  <div class="cmd-palette">
    <div class="cmd-header">
      ...
      <input type="text" placeholder="${args.placeholder || 'Type a command or search...'}" />
      <kbd>ESC</kbd>
    </div>
...
export const Default: Story = {
  args: { placeholder: 'Type a command or search...', maxResults: 10, showRecent: true },
