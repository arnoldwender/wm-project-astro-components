import{b as r}from"./lit-element-CdmuTPXr.js";const p={title:"Layouts/LandingLayout",tags:["autodocs"],parameters:{docs:{description:{component:`
...
`,e={render:()=>m()},t={render:()=>r`
...
}`,...(i=(o=e.parameters)==null?void 0:o.docs)==null?void 0:i.source}}};var a,d,s;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`{
  render: () => html\`
    <div style="min-height: 100vh; display: flex; flex-direction: column; font-family: system-ui, sans-serif; background: #0f172a; color: white;">
      <header style="padding: 1rem 2rem; border-bottom: 1px solid #1e293b;">
        <span style="font-weight: 700;">Dark Landing</span>
  ...
  \`
}`,...(s=(d=t.parameters)==null?void 0:d.docs)==null?void 0:s.source}}};const f=["Default","DarkVariant"];export{t as DarkVariant,e as Default,f as __namedExportsOrder,p as default};
