import{b as i}from"./lit-element-CdmuTPXr.js";const f={title:"Sections/ResourceCard",tags:["autodocs"],parameters:{docs:{description:{component:"Downloadable resource or document card. Four variants (default, card, compact, horizontal). Auto file type icon and color coding (PDF, DOC, XLS, etc.)."}}},argTypes:{variant:{control:"select",options:["default","card","compact","horizontal"]},fileType:{control:"select",options:["pdf","doc","xls","zip"]}}},e={render:()=>i`
  ...
  `},r={render:()=>i`
    <div style="max-width:28rem;padding:2rem;font-family:system-ui,sans-serif;">
      ${["Brand Guidelines (ZIP, 12 MB)","Price List (XLS, 1.2 MB)","Product Brochure (PDF, 5.6 MB)"].map((c,t)=>i`
        <a href="#" style="display:flex;align-items:center;gap:0.75rem;padding:0.75rem;border-radius:0.5rem;text-decoration:none;color:#1e293b;">
          <div style="width:2.5rem;height:2.5rem;border-radius:0.5rem;background:${["#fef3c7","#dcfce7","#fee2e2"][t]};color:${["#d97706","#16a34a","#dc2626"][t]};display:flex;align-items:center;justify-content:center;font-size:0.625rem;font-weight:700;">${["ZIP","XLS","PDF"][t]}</div>
          <div style="flex:1;"><span style="font-size:0.875rem;font-weight:600;">${c}</span></div>
  ...
  \`
}`,...(a=(o=e.parameters)==null?void 0:o.docs)==null?void 0:a.source}}};var s,d,l;r.parameters={...r.parameters,docs:{...(s=r.parameters)==null?void 0:s.docs,source:{originalSource:`{
  render: () => html\`
    <div style="max-width:28rem;padding:2rem;font-family:system-ui,sans-serif;">
  ...
  \`
}`,...(l=(d=r.parameters)==null?void 0:d.docs)==null?void 0:l.source}}};const p=["Default","Compact"];export{r as Compact,e as Default,p as __namedExportsOrder,f as default};
