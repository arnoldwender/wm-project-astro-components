import{b as r}from"./lit-element-CdmuTPXr.js";const g={title:"Sections/PricingSection",tags:["autodocs"],parameters:{docs:{description:{component:"Flexible pricing display section. Four layout variants (cards, comparison, toggle, minimal). Built-in billing-period toggle dispatching custom events."}}},argTypes:{variant:{control:"select",options:["cards","comparison","toggle","minimal"]},columns:{control:{type:"range",min:2,max:4}}}},p=[{name:"Starter",price:"9",desc:"For individuals",features:["5 Projects","10 GB Storage","Email Support"]},{name:"Pro",price:"29",desc:"For teams",features:["Unlimited Projects","100 GB Storage","Priority Support"],featured:!0},{name:"Enterprise",price:"99",desc:"For organizations",features:["Everything in Pro","Dedicated Manager","Custom SLA"]}],t={render:()=>r`
    <section style="padding:4rem 2rem;font-family:system-ui,sans-serif;">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:2rem;max-width:64rem;margin:0 auto;align-items:start;">
        ${p.map(e=>r`
          <div style="position:relative;border-radius:1rem;padding:2rem;background:#fff;${e.featured?"border:2px solid #3b82f6;box-shadow:0 10px 40px rgba(59,130,246,0.15);transform:scale(1.05);z-index:1;":"border:1px solid #e2e8f0;"}">
            ${e.featured?r`<div style="position:absolute;top:-0.75rem;left:50%;transform:translateX(-50%);"><span style="padding:0.25rem 1rem;font-size:0.75rem;font-weight:600;text-transform:uppercase;background:#3b82f6;color:white;border-radius:9999px;">Most Popular</span></div>`:""}
            <h3 style="font-size:1.25rem;font-weight:700;color:#1e293b;margin:0 0 0.25rem;">${e.name}</h3>
            <p style="font-size:0.875rem;color:#94a3b8;margin:0 0 1.5rem;">${e.desc}</p>
            <div style="font-size:2.5rem;font-weight:700;color:#1e293b;margin-bottom:1.5rem;">€${e.price}<span style="font-size:1rem;font-weight:400;color:#94a3b8;">/mo</span></div>
            <ul style="list-style:none;padding:0;margin:0 0 2rem;">
              ${e.features.map(d=>r`<li style="display:flex;align-items:center;gap:0.5rem;padding:0.375rem 0;font-size:0.875rem;color:#64748b;"><svg width="16" height="16" fill="none" stroke="#22c55e" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>${d}</li>`)}
            </ul>
            <a href="#" style="display:block;text-align:center;padding:0.75rem;border-radius:0.5rem;font-weight:600;text-decoration:none;${e.featured?"background:#3b82f6;color:white;":"border:2px solid #e2e8f0;color:#1e293b;"}">Get Started</a>
          </div>
        `)}
      </div>
    </section>
  `},i={render:()=>r`
    <section style="padding:4rem 2rem;font-family:system-ui,sans-serif;text-align:center;">
      ...
      <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:2rem;max-width:48rem;margin:0 auto;">
        ${[{name:"Basic",price:"12"},{name:"Premium",price:"36"}].map(e=>r`
          <div style="border:1px solid #e2e8f0;border-radius:1rem;padding:2rem;background:#fff;">
            <h3 style="font-size:1.25rem;font-weight:700;margin:0 0 1rem;">${e.name}</h3>
            <div style="font-size:2.5rem;font-weight:700;margin-bottom:0.5rem;">€${e.price}<span style="font-size:1rem;font-weight:400;color:#94a3b8;">/mo</span></div>
  ...
  \`
}`,...(a=(n=t.parameters)==null?void 0:n.docs)==null?void 0:a.source}}};var s,l,m;i.parameters={...i.parameters,docs:{...(s=i.parameters)==null?void 0:s.docs,source:{originalSource:`{
  render: () => html\`
    <section style="padding:4rem 2rem;font-family:system-ui,sans-serif;text-align:center;">
      <h2 style="font-size:2rem;font-weight:700;color:#1e293b;margin:0 0 2rem;">Simple, Transparent Pricing</h2>
      <div style="display:flex;align-items:center;justify-content:center;gap:1rem;margin-bottom:3rem;">
  ...
  \`
}`,...(m=(l=i.parameters)==null?void 0:l.docs)==null?void 0:m.source}}};const f=["Default","WithToggle"];export{t as Default,i as WithToggle,f as __namedExportsOrder,g as default};
