import{b as o}from"./lit-element-CdmuTPXr.js";const m={title:"Sections/ErrorSection",tags:["autodocs"],parameters:{docs:{description:{component:`
...
- Optional search bar and suggested links
        `}}},argTypes:{variant:{control:"select",options:["default","illustrated","minimal","creative","split","branded"],description:"Design variant"},code:{control:"text",description:"Error code"},title:{control:"text",description:"Error title"},showSearch:{control:"boolean",description:"Show search bar"}}},c=e=>o`
  <section style="min-height: 500px; display: flex; align-items: center; justify-content: center; padding: 2rem; text-align: center;">
    <div style="max-width: 32rem;">
      <p style="font-size: 6rem; font-weight: 800; color: #3b82f6; margin: 0; line-height: 1;">${e.code}</p>
      <h1 style="font-size: 1.5rem; font-weight: 700; color: #1e293b; margin: 1rem 0 0.5rem;">${e.title}</h1>
      <p style="color: #64748b; margin: 0 0 2rem;">${e.description}</p>
...
`,r={args:{variant:"default",code:"404",title:"Page not found",description:"Sorry, we could not find the page you are looking for.",showSearch:!1},render:e=>c(e)},t={args:{variant:"illustrated",code:"500",title:"Something went wrong",description:"Our servers are having trouble. Please try again later.",showSearch:!0},render:e=>c(e)};var n,a,i;r.parameters={...r.parameters,docs:{...(n=r.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    variant: 'default',
    code: '404',
...
}`,...(i=(a=r.parameters)==null?void 0:a.docs)==null?void 0:i.source}}};var s,d,l;t.parameters={...t.parameters,docs:{...(s=t.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    variant: 'illustrated',
    code: '500',
  ...
  render: args => renderError(args)
}`,...(l=(d=t.parameters)==null?void 0:d.docs)==null?void 0:l.source}}};const g=["NotFound","ServerError"];export{r as NotFound,t as ServerError,g as __namedExportsOrder,m as default};
