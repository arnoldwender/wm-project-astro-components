import{b as t}from"./lit-element-CdmuTPXr.js";const x={title:"Sections/Hero",tags:["autodocs"],parameters:{docs:{description:{component:`
...
- Responsive text sizing
        `}}},argTypes:{title:{control:"text",description:"Hero headline"},subtitle:{control:"text",description:"Subtitle above headline"},description:{control:"text",description:"Supporting text"},overlay:{control:"boolean",description:"Dark overlay on image"},scrollIndicator:{control:"boolean",description:"Show scroll indicator"},variant:{control:"select",options:["default","minimal","tool"],description:"Layout variant"}}},y=e=>t`
  <section style="position: relative; min-height: 500px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
    ...
    ${e.overlay?t`<div style="position: absolute; inset: 0; background: linear-gradient(to bottom, rgba(0,0,0,0.6), rgba(0,0,0,0.4), rgba(0,0,0,0.8)); z-index: 1;"></div>`:""}
    <div style="position: relative; z-index: 10; text-align: center; color: #fff; padding: 2rem; max-width: 48rem;">
      ${e.subtitle?t`<span style="font-size: 0.875rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.15em; opacity: 0.8; display: block; margin-bottom: 1rem;">${e.subtitle}</span>`:""}
      <h1 style="font-size: clamp(2rem, 6vw, 3.5rem); font-weight: 800; margin: 0 0 1rem; line-height: 1.1;">${e.title}</h1>
      ${e.description?t`<p style="font-size: 1.25rem; opacity: 0.85; margin: 0 0 2rem; line-height: 1.5;">${e.description}</p>`:""}
...
`,r={args:{title:"Welcome to Acme Corp",subtitle:"Digital Solutions",description:"We build modern, accessible websites that drive results.",overlay:!0,scrollIndicator:!0,variant:"default"},render:e=>y(e)},i={args:{title:"Build Something Amazing",subtitle:"",description:"",overlay:!1,scrollIndicator:!1,variant:"default"},render:e=>y(e),name:"Default — No Overlay"},o={args:{variant:"minimal"},render:()=>t`
  ...
  `,name:"Minimal"},n={args:{variant:"tool"},render:()=>t`
      ...
      <div style="position: relative; z-index: 10; color: #fff; padding: 3rem 2rem; max-width: 72rem; margin: 0 auto; width: 100%;">
        ...
        <div style="max-width: 48rem;">
          ...
          <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 1.5rem; padding-top: 2rem; border-top: 1px solid rgba(75,85,99,0.5);">
            ${[{value:"99.9%",label:"Uptime"},{value:"<50ms",label:"Avg Latency"},{value:"10M+",label:"Requests/day"},{value:"150+",label:"Endpoints"}].map(e=>t`
              <div>
                <div style="font-size: 1.5rem; font-weight: 700; color: #fff;">${e.value}</div>
                <div style="font-size: 0.875rem; color: #6b7280; margin-top: 0.25rem;">${e.label}</div>
              </div>
            `)}
          </div>
        </div>
  ...
  `,name:"Tool"};var a,l,s;r.parameters={...r.parameters,docs:{...(a=r.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {
    title: 'Welcome to Acme Corp',
    subtitle: 'Digital Solutions',
    description: 'We build modern, accessible websites that drive results.',
    overlay: true,
    scrollIndicator: true,
    variant: 'default'
  },
  render: args => renderHero(args)
}`,...(s=(l=r.parameters)==null?void 0:l.docs)==null?void 0:s.source}}};var d,m,c;i.parameters={...i.parameters,docs:{...(d=i.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
...
}`,...(c=(m=i.parameters)==null?void 0:m.docs)==null?void 0:c.source}}};var p,g,f;o.parameters={...o.parameters,docs:{...(p=o.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    variant: 'minimal'
  },
  render: () => html\`
  ...
  \`,
  name: 'Minimal'
}`,...(f=(g=o.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var u,h,v;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    variant: 'tool'
  },
  render: () => html\`
  ...
  \`,
  name: 'Tool'
}`,...(v=(h=n.parameters)==null?void 0:h.docs)==null?void 0:v.source}}};const w=["Default","NoOverlay","Minimal","Tool"];export{r as Default,o as Minimal,i as NoOverlay,n as Tool,w as __namedExportsOrder,x as default};
