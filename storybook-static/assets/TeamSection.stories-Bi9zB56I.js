import{b as n}from"./lit-element-CdmuTPXr.js";const c={title:"Sections/TeamSection",tags:["autodocs"],parameters:{docs:{description:{component:"Team showcase section. Six variants (grid, cards, horizontal, overlay, minimal, featured). Configurable 2-6 columns, optional SectionHeader, featured slot."}}},argTypes:{variant:{control:"select",options:["grid","cards","horizontal","overlay","minimal","featured"]},columns:{control:{type:"range",min:2,max:6}}}},d=[{name:"Jane Doe",role:"CEO & Founder",initials:"JD"},{name:"John Smith",role:"CTO",initials:"JS"},{name:"Maria Garcia",role:"Head of Design",initials:"MG"},{name:"Alex Chen",role:"Lead Engineer",initials:"AC"}],t={render:()=>n`
        ...
        ${d.map(e=>n`
          <div style="text-align:center;">
            <div style="width:8rem;height:8rem;border-radius:50%;background:linear-gradient(135deg,rgba(59,130,246,0.2),rgba(59,130,246,0.4));display:flex;align-items:center;justify-content:center;margin:0 auto 1rem;">
              <span style="font-size:2rem;font-weight:700;color:#3b82f6;">${e.initials}</span>
            </div>
            <h3 style="font-weight:600;margin:0 0 0.25rem;">${e.name}</h3>
            <p style="font-size:0.875rem;color:#3b82f6;font-weight:500;margin:0;">${e.role}</p>
          </div>
        `)}
      </div>
    </section>
        ...
        ${d.slice(0,3).map(e=>n`
          <div style="background:white;border:1px solid #e2e8f0;border-radius:1rem;padding:1.5rem;text-align:center;">
            <div style="width:5rem;height:5rem;border-radius:50%;background:linear-gradient(135deg,rgba(59,130,246,0.2),rgba(59,130,246,0.4));display:flex;align-items:center;justify-content:center;margin:0 auto 1rem;">
              <span style="font-size:1.5rem;font-weight:700;color:#3b82f6;">${e.initials}</span>
            </div>
            <h3 style="font-weight:600;margin:0 0 0.25rem;">${e.name}</h3>
            <p style="font-size:0.875rem;color:#3b82f6;margin:0;">${e.role}</p>
          </div>
        `)}
      </div>
    </section>
  `};var i,a,s;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:`{
  render: () => html\`
    <section style="padding:4rem 2rem;font-family:system-ui,sans-serif;">
      <div style="text-align:center;margin-bottom:3rem;">
        <span style="font-size:0.875rem;font-weight:600;text-transform:uppercase;color:#3b82f6;display:block;margin-bottom:0.5rem;">Our Team</span>
  ...
  \`
}`,...(s=(a=t.parameters)==null?void 0:a.docs)==null?void 0:s.source}}};var o,m,l;r.parameters={...r.parameters,docs:{...(o=r.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: () => html\`
    <section style="padding:4rem 2rem;background:#f8fafc;font-family:system-ui,sans-serif;">
      <h2 style="text-align:center;font-size:2rem;font-weight:700;margin:0 0 3rem;">Leadership</h2>
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1.5rem;max-width:56rem;margin:0 auto;">
  ...
  \`
}`,...(l=(m=r.parameters)==null?void 0:m.docs)==null?void 0:l.source}}};const p=["Default","Cards"];export{r as Cards,t as Default,p as __namedExportsOrder,c as default};
