import{b as l}from"./lit-element-CdmuTPXr.js";const m={title:"Sections/TestimonialCard",tags:["autodocs"],parameters:{docs:{description:{component:"Individual testimonial card. Four variants (card, minimal, social, large). Five-star rating display, source platform icon, initials fallback avatar."}}},argTypes:{variant:{control:"select",options:["card","minimal","social","large"]},rating:{control:{type:"range",min:1,max:5}}}},e={render:()=>l`
  ...
  `};var i,r,n;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
  render: () => html\`
    <div style="max-width:24rem;padding:2rem;font-family:system-ui,sans-serif;">
      <div style="background:white;border:1px solid #e2e8f0;border-radius:0.75rem;padding:1.5rem;">
        <div style="display:flex;gap:0.125rem;margin-bottom:1rem;color:#f59e0b;">★★★★★</div>
  ...
  \`
}`,...(n=(r=e.parameters)==null?void 0:r.docs)==null?void 0:n.source}}};var o,s,a;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: () => html\`
    <div style="padding:3rem;font-family:system-ui,sans-serif;text-align:center;max-width:48rem;margin:0 auto;">
      <div style="display:flex;justify-content:center;gap:0.125rem;margin-bottom:1.5rem;color:#f59e0b;font-size:1.25rem;">★★★★★</div>
      <blockquote style="font-size:1.75rem;font-weight:500;font-style:italic;color:#1e293b;margin:0 0 2rem;line-height:1.5;">
  ...
  \`
}`,...(a=(s=t.parameters)==null?void 0:s.docs)==null?void 0:a.source}}};const c=["Default","Large"];export{e as Default,t as Large,c as __namedExportsOrder,m as default};
