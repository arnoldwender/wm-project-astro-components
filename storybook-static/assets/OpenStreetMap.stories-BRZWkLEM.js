import{b as p}from"./lit-element-CdmuTPXr.js";const h={title:"Maps/OpenStreetMap",tags:["autodocs"],parameters:{docs:{description:{component:`
...
- Grid-pattern SVG placeholder before consent
        `}}},argTypes:{lat:{control:"number",description:"Latitude coordinate"},lng:{control:"number",description:"Longitude coordinate"},height:{control:"text",description:"Map height"},title:{control:"text",description:"Map title"},buttonText:{control:"text",description:"Consent button text"},tileProvider:{control:"select",options:["osm","carto","stamen"],description:"Tile provider"}}},d=e=>p`
  <div style="width: 100%; height: ${e.height}; position: relative; background: #f3f4f6; border-radius: 0.5rem; overflow: hidden; font-family: system-ui, sans-serif;">
    <div style="position: absolute; inset: 0; display: flex; align-items: center; justify-content: center;">
      ...
      <div style="position: relative; z-index: 1; text-align: center; padding: 2rem; max-width: 400px; background: white; border-radius: 0.75rem; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
        ...
        <h3 style="margin: 0 0 0.5rem; font-size: 1.125rem; font-weight: 600; color: #1f2937;">${e.title}</h3>
...
`,t={args:{lat:51.4828,lng:11.97,height:"400px",title:"OpenStreetMap",buttonText:"Karte laden",tileProvider:"osm"},render:e=>d(e)},r={args:{lat:48.1351,lng:11.582,height:"500px",title:"Our Location",buttonText:"Show map",tileProvider:"carto"},render:e=>d(e)};var o,n,i;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    lat: 51.4828,
    lng: 11.97,
    height: '400px',
...
}`,...(i=(n=t.parameters)==null?void 0:n.docs)==null?void 0:i.source}}};var a,s,l;r.parameters={...r.parameters,docs:{...(a=r.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {
    lat: 48.1351,
    lng: 11.582,
    height: '500px',
  ...
  render: args => renderOSM(args)
}`,...(l=(s=r.parameters)==null?void 0:s.docs)==null?void 0:l.source}}};const m=["Default","TallMap"];export{t as Default,r as TallMap,m as __namedExportsOrder,h as default};
